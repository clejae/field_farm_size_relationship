## All this found at: https://github.com/konosp/propensity-score-matching/blob/main/functions.py
import math
import pandas as pd
...
def cohenD(tmp, metricName):
    ...
    d = (treated_metric.mean() - untreated_metric.mean()) / math.sqrt(((treated_metric.count() - 1) * treated_metric.std() ** 2 + (
